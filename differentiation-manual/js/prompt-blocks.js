...
- Concrete, specific language, with no metaphors, abstract terms, or implied information
...
Instructional nuance: Visuals should be simple, unambiguous, and culturally appropriate. They should serve as memory aids and comprehension supports, not artwork.
...
1. Annotated diagram or visual: Describe exactly what students should create and annotate, including what should be labelled and what needs to be shown.
...
3. Structured dot-point response: A scaffolded written option with clear instructions, specifying how many points, what each point should cover, with sentence starters for each.
...
5. Flag any content currently embedded in images and cannot be read by TTS, and suggest how to provide equivalent text-based access
